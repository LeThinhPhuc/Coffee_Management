...
const MenuModel = (props) => {
    ...
    return (
        <div>
            ...
            transition-all custom-animate-pulse max-h-screen"
            >
                <div className="relative w-auto overflow-hidden my-6 mx-auto max-w-3xl max-h-[100%]">
                    {/*//! Alert */}
                    <div
                        className={`alert ${
                            submitFail ? "active" : ""
            ...
            <div className="opacity-25 fixed inset-0 z-30 bg-black max-h-screen"></div>
        </div>
    );
};
