...
const MenuModel = (props) => {
  ...
  const alert = '<div class="p-4 mb-4 text-sm text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400" role="alert">
  <span class="font-medium">Thông báo!</span> Cần điền đầy đủ thông tin trước khi xác nhận
</div>'
