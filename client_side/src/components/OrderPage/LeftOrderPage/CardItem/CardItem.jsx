...
const CardItem = ({ items }) => {
    ...
    return (
        ...
        <img src={items.imagePath} className="absolute inset-0 h-full w-full object-cover" alt={items.name} />
        <div className={`absolute inset-0 w-full h-full bg-gradient-to-t ${checkTheme ? 'from-black/100 to-black/0' : 'from-[#dfccaf]/100 via-[#dfccaf]/60 to-[#dfccaf]/0'}`}></div>
