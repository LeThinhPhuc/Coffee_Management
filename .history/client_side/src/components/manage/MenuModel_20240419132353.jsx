...
const MenuModel = (props) => {
    ...
    useEffect(() => {
        // Nếu submitFail là true, thiết lập một timeout để đặt submitFail về false sau 3 giây
        console.log("Work");
        let timer;
        if (submitFail) {
            timer = setTimeout(() => {
    ...
    return (
        <div>
            ...
            {submitFail && (
                <div
                    className="z-50 p-4 mb-4 text-sm text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400"
                    role="alert"
                >
                    <span className="font-medium">Thông báo!</span> Cần điền đầy
                    đủ thông tin trước khi xác nhận
                </div>
            )}
