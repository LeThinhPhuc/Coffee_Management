...
const RightOrderPage = () => {
  ...
  return (
    <div>
      <div className="font-bold text-[#6f4436]  flex items-center justify-center textright textlg">
        Lacome Coffee
      </div>
      <div className="p-2 pt-0 font-bold text-[#be9b7b]  textright textlg">
        Order
      </div>
      ...
      <div className="flex justify-center items-center">
        <div
          onClick={handleModal}
          className="flex justify-center items-center margin-[0 auto] cursor-pointer p-5 border-2 mx-2 text-[vw] max-w-[300px] min-w-[100px] textbase rounded-md "
        >
      ...
      <div className="flex justify-center items-center pt-5">
        <div className="flex justify-center items-center bg-[#be9b7b] w-[16vw] min-w-[100px] h-[4vw] min-h-[20px] rounded-md cursor-pointer text-[1.7vw]">
          Confirm Order
        </div>
      </div>
              ...
              <div class="mb-6">
                ...
                <div className="flex justify-between pr-2 pl-2 pb-3">
                  ...
                  <div className="flex items-center ">
                    ...
                    {/* Sử dụng cnt để hiển thị giá trị soluong */}
        ...
        <div className="fixed inset-0 z-[999] grid place-items-center bg-black bg-opacity-60 opacity-100 backdrop-blur-sm">
          <div className="relative m-4 w-1/4 min-w-[25%] max-w-[25%] rounded-lg bg-white font-sans text-base font-light leading-relaxed text-blue-gray-500 antialiased shadow-2xl">
            ...
            <div className="overflow-y-scroll p-4 !px-5 font-sans text-base font-light leading-relaxed text-blue-gray-500 antialiased">
              {/* Content here */}
              <div class="mb-6">
                <p class="block py-3 font-sans text-base antialiased font-semibold leading-relaxed uppercase text-blue-gray-900 opacity-70">
                  Popular
                </p>
