...
const MenuItem = (props) => {
    ...
    return (
        ...
        >
            ...
            <div className="">
                <h5
                    className={` block text-lg antialiased font-extrabold leading-snug tracking-normal text-blue-gray-900
                     `}
                >
                    {propsItem.name}
                </h5>
                <p className="font-bold text-[#854442] mt-2">
                ...
                {props.type == "menu" ? (
                    ...
                    <p className="block text-base antialiased font-semibold leading-relaxed text-inherit">
                        <span className="block">
                            Create: {formatDate(propsItem.dateCreated)}
                        </span>
                        <span className="block">
